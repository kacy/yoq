...
fn loadPreviousSuccessfulDeployment(
    ...
    return app_route_responses.loadPreviousSuccessfulDeployment(db, alloc, app_name, exclude_release_id);
}
...
fn formatAppStatusResponseFromDeployments(
    ...
    return app_route_responses.formatStatusFromDeployments(alloc, db, latest, previous_successful);
}
