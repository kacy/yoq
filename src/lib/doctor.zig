...
pub fn checkCgroupV2() Check {
    const file = linux_platform.openFileAbsolute("/sys/fs/cgroup/cgroup.controllers", .{}) catch {
...
pub fn checkEbpf() Check {
    linux_platform.accessAbsolute("/sys/fs/bpf", .{}) catch {
...
pub fn checkWireguard() Check {
    linux_platform.accessAbsolute("/sys/module/wireguard", .{}) catch {
