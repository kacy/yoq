...
/// cluster management (agents and assignments tables). this allowlist
/// blocks arbitrary SQL injection from compromised raft peers — a single
/// malicious entry would otherwise be replicated to every node in the
/// cluster.
///
/// allowed patterns match the SQL generated by registry.zig and scheduler.zig:
///   - INSERT/UPDATE/DELETE on agents and assignments tables
