...
pub fn matchesMemberAddr(expected: gossip_mod.MemberAddr, actual: linux_platform.net.Address) bool {
...
test "isTrustedSender matches configured gossip member endpoint" {
    ...
    const trusted = transport_mod.GossipReceiveResult{
        .sender_id = 2,
        .from_addr = linux_platform.net.Address.initIp4(.{ 10, 0, 0, 2 }, 9800),
        .payload = "ping",
    };
    ...
    const spoofed_ip = transport_mod.GossipReceiveResult{
        .sender_id = 2,
        .from_addr = linux_platform.net.Address.initIp4(.{ 10, 0, 0, 9 }, 9800),
        .payload = "ping",
    };
    ...
    const spoofed_port = transport_mod.GossipReceiveResult{
        .sender_id = 2,
        .from_addr = linux_platform.net.Address.initIp4(.{ 10, 0, 0, 2 }, 9810),
        .payload = "ping",
    };
