...
pub const RolloutFailureAction = shared_types.RolloutFailureAction;
pub const RolloutStrategy = shared_types.RolloutStrategy;
pub const RolloutPolicy = shared_types.RolloutPolicy;
