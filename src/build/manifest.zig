...
fn parseStep(step: []const u8) ?ParsedStep {
    ...
    const kind = matchKeyword(keyword) orelse return null;
...
/// case-insensitive keyword matching for step instructions
fn matchKeyword(keyword: []const u8) ?dockerfile.InstructionKind {
